...
namespace SCHALE {
    ...
    public partial class usersDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public usersRow AddusersRow(string username, string password, string first_name, string last_name, string email) {
...
namespace SCHALE.usersDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([username], [password], [first_name], [last_name], [em" +
                "ail]) VALUES (@username, @password, @first_name, @last_name, @email);\r\nSELECT us" +
                "ername, password, first_name, last_name, id, email FROM users WHERE (id = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [username] = @username, [password] = @password, [first_name] = @first_name, [last_name] = @last_name, [email] = @email WHERE (([username] = @Original_username) AND ([password] = @Original_password) AND ((@IsNull_first_name = 1 AND [first_name] IS NULL) OR ([first_name] = @Original_first_name)) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) OR ([last_name] = @Original_last_name)) AND ([id] = @Original_id) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT username, password, first_name, last_name, id, email FROM users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SCHALE.Properties.Settings.Default.usersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, password, first_name, last_name, id, email FROM dbo.users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT username, password, first_name, last_name, id, email FROM dbo.users";
        ...
        public virtual int FillBy(usersDataSet.usersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_first_name, string Original_last_name, int Original_id, string Original_email) {
        ...
        public virtual int Insert(string username, string password, string first_name, string last_name, string email) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, string first_name, string last_name, string email, string Original_username, string Original_password, string Original_first_name, string Original_last_name, int Original_id, string Original_email, int id) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, string first_name, string last_name, string email, string Original_username, string Original_password, string Original_first_name, string Original_last_name, int Original_id, string Original_email) {
            return this.Update(username, password, first_name, last_name, email, Original_username, Original_password, Original_first_name, Original_last_name, Original_id, Original_email, Original_id);
        }
    }
